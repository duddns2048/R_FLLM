...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_flag', default='organsmnist', type=str)
    ...
    save_dataset(train_dataset, f"./datasets/{data_flag}_224", "train")
    save_dataset(val_dataset, f"./datasets/{data_flag}_224", "val")
    save_dataset(test_dataset, f"./datasets/{data_flag}_224", "test")
